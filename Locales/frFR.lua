...
L["WorldDefense"] = "Défense globale"
L["LookingForGroup"] = "RechercheDeGroupe"
L["GuildRecruitment"] = "RecrutementDeGuilde"
L["Say"] = "Dire"
L["Yell"] = "Crier"
L["Whisper"] = "Chuchoter"
L["Spamming"] = "Spam"
...
L["Add player to permanent blacklist, you'll no longer see any message from them on channel where Adblock is active"] = "Ajoute un joueur à la liste noire, vous ne verrez plus les messages de cette personne sur les canaux ou AdBlock est actif"
...
L["Sync Pals"] = "Synchro. les copains"
...
L["Autoblock mode: adds to the permanent blocklist repeating offenders"] = "Ajout automatique des spammeurs récalcitrants dans la liste noire"
 L["Show how many messages were blocked this session/overall"] =  "Affiche le nombre de messages indésirables bloqués cette session/en tout"
L["Recommended usage:"] =  "Usage recommandé:"
L["Type in /s \"adblock:test\" to make sure the addon works"] = "Taper /s \"adblock:test\" pour vous assurer que l'addon fonctionne"
L["Type /ab  or click on the button below and start fine-tuning the AdBlock to your taste"] =  "Taper /ab ou cliquer sur le bouton ci-dessous et commencer à personnaliser AdBlock selon vos envies"
...
L["Later, remove Audit and switch to Verbose to see when messages are being blocked"] = "Plus tard, passer de Simuler à \"Bavard\" pour savoir quand un message est bloqué"
